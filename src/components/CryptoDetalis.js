...
import selectArrow from "../assets/select-icon.svg";
          ...
          <div className="flex items-center justify-between h-full w-full p-4">
            <div className="flex flex-col w-[45%] h-full pr-2">
              <div className="flex w-full items-center">
                ...
                <span className="test-sm py-0.5 px-2.5 ml-2 bg-Pneon-100 text-Pneon-50 bg-opacity-25 uppercase rounded">
                  {data.symbol}
                </span>
              </div>
              ...
              <div className="flex  w-full mt-4 justify-between">
                ...
                <div className="flex flex-col content-start">
                  ...
                  <div className="flex justify-between">
                    <div
                      className={`
                      text-sm px-1 ml-2 my-1 font-medium flex items-center rounded uppercase bg-opacity-25 bg-green text-green
                    `}
                    >
                      <span>
                      ...
                      <img
                        className={` w-[1rem] ml-0.5 flex ${data.sentiment_votes_up_percentage}
                        `}
                        src={selectArrow}
                        alt="arrowinfo"
                      />
