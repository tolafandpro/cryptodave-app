    ...
    return ( 
        <>
                            ...
                            cryptoData.map(data => {
                                return(
                                    <tr key={data.id} className="text-center text-base border-b border-gray-100 hover:bg-gray-200 last:border-b-0">
                                        ...
                                        <td className="py-4 md:table-cell hidden text-green">{data.market_cap_change_percentage_24h}%</td>
            ...
            <div className="flex md:flex-row flex-col items-center justify-between mt-4 capitalize h-[2rem]">
                <span>Data provided by <a className="text-Pneon-50" href="http://www.coingecko.com" rel="noreferrer" target={"_blank"}>CoinGecko</a></span>
                <Pagination />
            </div>
        </>
     );
