    ...
    return ( 
        <section className="w-[80%] h-full flex flex-col mt-16 mb-24 relative">
            <div className="w-full min-h-[60vh] py-8 flex flex-wrap justify-evenly border border-gray-100 rounded">
                ...
                <span onClick={resetTrendingResult} className='hover:scale-110 transition-all transition-ease cursor-pointer absolute right-10 -top-9'>reset</span>
                <button onClick={resetTrendingResult}
